                                ...
                                @foreach($albums as $album)
                                    <tr>
                                        ...
                                        <td class="project-actions">
                                            <a class="btn btn-warning btn-sm" href="{{ route('admin.albums.photos.index', $album->id) }}">
                                                <i class="fas fa-external-link-square-alt"></i>
                                                Фотографии
                                            </a>
                                            <a class="btn btn-primary btn-sm" href="{{ route('admin.albums.show', $album->id) }}">
                                            ...
                                            <form id="delete_album_form-{{ $album->id }}" style="display: none;" action="{{ route('admin.albums.destroy', $album->id) }}" method="post">
                                                @csrf
                                                @method('delete')
                                            </form>
