                                ...
                                @foreach($appeals as $person)
                                    <tr>
                                        ...
                                        <td class="project-actions">
                                            ...
                                            <a class="btn btn-info btn-sm" href="{{ route('admin.appeals.edit', $person->id) }}">
                                                <i class="fas fa-pencil-alt"></i>
                                                Редактировать
                                            </a>
                                            <form id="delete_appeals_form-{{ $person->id }}" style="display: none;" action="{{ route('admin.appeals.destroy', $person->id) }}" method="post">
                                                @csrf
                                                @method('delete')
                                            </form>
                                            <a class="btn btn-danger btn-sm" onclick="document.getElementById('delete_appeals_form-{{ $person->id }}').submit(); return false;">
